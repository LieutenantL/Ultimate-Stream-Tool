...
const pRank = document.getElementsByClassName("rank");
...
async function getData(scInfo) {
	...
	if (startup) {
		...
		idTimeout = setTimeout( bodyFadeOut, 5900);
...
function bodyFadeOut() {	
	...
	nameFadeOut(pRank[0]);
	nameFadeOut(pRank[1]);
	nameFadeOut(pSponsor[0]);
	nameFadeOut(pSponsor[1]);
...
function updatePR(pNum, tag, name) {
	if(pNum == 1){
		document.getElementById("charP2").style.zIndex = "-1";
		document.getElementById("p2Rank").style.zIndex = "-1";
	}
	let rankString;
	for(let i = 0; i < prList.length; i++) {
		if(prList[i].name == name) {
			if(prList[i].tag != ""){
				pSponsor[pNum].src = "Resources/Logos/Sponsor/" + prList[i].tag + ".png";
			}
			rankString = "#" + (i+1);
			break;
		} else {
			pSponsor[pNum].src = "Resources/Literally Nothing.png";
		}
	}

	pRank[pNum].textContent = rankString;
	fadeIn(pSponsor[pNum], .7);
	fadeIn(pRank[pNum], .7);
}
...
function updateChar(pNum, name, pCharacter, pSkin, startup=false) {
	...
	if (startup) {
		//if the video cant be found, show Random
		...
		if(prList[rank].characters.length > 1) {
			for(let i = 0; i < prList[rank].characters.length; i++){
				if(prList[rank].characters[i].name == pCharacter) {
					if(prList[rank].characters[i].hasWebm == "True" && !set) {
			...
			if(prList[rank].characters[0].hasWebm == "True" && prList[rank].characters[0].name == pCharacter) {
...
function checkTournament(tourneyName) {
	let space = tourneyName.search(" ");
	let actualName = tourneyName.substring(0, space);
	let mainColor = "#f7f9f7";
	let accentColor;
	if(actualName == "ESF") {
		front.src = "Resources/Overlay/VS Screen/ESFfrontofcharacters.png";
		behind.src = "Resources/Overlay/VS Screen/ESFbehindcharacters.png";
		BG.src = "Resources/Overlay/VS Screen/ESFBG.png";
		accentColor = "#053b0c";
	} else if(actualName == "TSD" || actualName == "BOWU") {
		front.src = "Resources/Overlay/VS Screen/BOWUfrontofcharacters.png";
		behind.src = "Resources/Overlay/VS Screen/BOWUbehindcharacters.png";
		BG.src = "Resources/Overlay/VS Screen/BOWUBG.png";
		accentColor = "#ce7538";
	} else if(actualName == "SSBE") {
		front.src = "Resources/Overlay/VS Screen/SSBEfrontofcharacters.png";
		behind.src = "Resources/Overlay/VS Screen/SSBEbehindcharacters.png";
		BG.src = "Resources/Overlay/VS Screen/SSBEBG.png";
		accentColor = "#2b98c5";
	} else if(actualName == "IPA") {
		front.src = "Resources/Overlay/VS Screen/IPAfrontofcharacters.png";
		behind.src = "Resources/Overlay/VS Screen/IPAbehindcharacters.png";
		BG.src = "Resources/Overlay/VS Screen/IPABG.png";
		accentColor = "#2b98c5";
	} else if(actualName == "CSU") {
		front.src = "Resources/Overlay/VS Screen/CSUfrontofcharacters.png";
		behind.src = "Resources/Overlay/VS Screen/CSUbehindcharacters.png";
		BG.src = "Resources/Overlay/VS Screen/CSUBG.png";
		accentColor = "#1e4d2b";
	} else {
		front.src = "Resources/Overlay/VS Screen/ESFfrontofcharacters.png";
		behind.src = "Resources/Overlay/VS Screen/ESFbehindcharacters.png";
	...
	for(let i = 0; i < maxPlayers; i++) {
		pName[i].style.color = mainColor;
		pName[i].style.textShadow = "-1px -1px 0 " + accentColor +
									", 1px -1px 0 " + accentColor +
									", -1px 1px 0 " + accentColor +
									", 1px 1px 0 " + accentColor;
		pTag[i].style.color = accentColor;
		pTag[i].style.textShadow = "-1px -1px 0 " + mainColor +
									", 1px -1px 0 " + mainColor +
									", -1px 1px 0 " + mainColor +
									", 1px 1px 0 " + mainColor;
		pRank[i].style.color = mainColor;
		pRank[i].style.textShadow = "-1px -1px 0 " + accentColor +
									", 1px -1px 0 " + accentColor +
									", -1px 1px 0 " + accentColor +
									", 1px 1px 0 " + accentColor;
	}
