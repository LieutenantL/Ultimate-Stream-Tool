...
set number1=0
set number2=1
copy "C:\Users\leevi\Downloads\BulkResizePhotos.com\chara_2_%fighter%_0%number1%.png" "C:\Users\leevi\Desktop\Ultimate-Stream-Tool - Copy\Stream Tool\Resources\Characters\Stock Icons\"%fighterstring%"\"%fighterstring%"%number2%.png"
set number1=1
set number2=2
copy "C:\Users\leevi\Downloads\BulkResizePhotos.com\chara_2_%fighter%_0%number1%.png" "C:\Users\leevi\Desktop\Ultimate-Stream-Tool - Copy\Stream Tool\Resources\Characters\Stock Icons\"%fighterstring%"\"%fighterstring%"%number2%.png"
set number1=2
